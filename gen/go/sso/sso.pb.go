...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x04Auth\x128\n" +
	"\aReister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB3Z1github.com/stackrox/rox/generated/storage;storageb\x06proto3"
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Reister:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auth.IsAdmin:input_type -> auth.IsAdminRequest
	1, // 3: auth.Auth.Reister:output_type -> auth.RegisterResponse
